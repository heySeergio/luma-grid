...
const LEXEME_SEED = [
  ...
  },
  {
    ...
    frequencyScore: 0.8,
    forms: [
      makeSurface('doctor', { number: 'singular', gender: 'masc' }),
      makeSurface('doctora', { formType: 'variant', number: 'singular', gender: 'fem' }),
      makeSurface('doctores', { formType: 'plural', number: 'plural', gender: 'masc' }),
      makeSurface('doctoras', { formType: 'plural', number: 'plural', gender: 'fem' }),
    ],
  },
  {
    lemma: 'medicina',
    ...
    frequencyScore: 0.84,
    forms: [
      makeSurface('medicina', { number: 'singular', gender: 'fem' }),
      makeSurface('medicinas', { formType: 'plural', number: 'plural', gender: 'fem' }),
    ],
  },
  {
    lemma: 'colegio',
    ...
    frequencyScore: 0.82,
    forms: [
      makeSurface('colegio', { number: 'singular', gender: 'masc' }),
      makeSurface('colegios', { formType: 'plural', number: 'plural', gender: 'masc' }),
    ],
  },
  {
    lemma: 'profesor',
    ...
    frequencyScore: 0.76,
    forms: [
      makeSurface('profesor', { number: 'singular', gender: 'masc' }),
      makeSurface('profesora', { formType: 'variant', number: 'singular', gender: 'fem' }),
      makeSurface('profesores', { formType: 'plural', number: 'plural', gender: 'masc' }),
      makeSurface('profesoras', { formType: 'plural', number: 'plural', gender: 'fem' }),
    ],
  },
  {
    lemma: 'tarea',
    ...
    frequencyScore: 0.74,
    forms: [
      makeSurface('tarea', { number: 'singular', gender: 'fem' }),
      makeSurface('tareas', { formType: 'plural', number: 'plural', gender: 'fem' }),
    ],
  },
  {
    lemma: 'jugar',
    ...
    forms: [
      ...
      makeSurface('jugamos', { formType: 'finite', mood: 'indicative', tense: 'present', person: 1, number: 'plural' }),
      makeSurface('juegan', { formType: 'finite', mood: 'indicative', tense: 'present', person: 3, number: 'plural' }),
      makeSurface('jugó', { formType: 'finite', mood: 'indicative', tense: 'preterite', person: 3, number: 'singular' }),
      makeSurface('jugaron', { formType: 'finite', mood: 'indicative', tense: 'preterite', person: 3, number: 'plural' }),
    ],
  },
  {
    lemma: 'leer',
    ...
    frequencyScore: 0.74,
    forms: [
      makeSurface('leer', { formType: 'infinitive', mood: 'infinitive' }),
      makeSurface('leo', { formType: 'finite', mood: 'indicative', tense: 'present', person: 1, number: 'singular' }),
      makeSurface('lees', { formType: 'finite', mood: 'indicative', tense: 'present', person: 2, number: 'singular' }),
      makeSurface('lee', { formType: 'finite', mood: 'indicative', tense: 'present', person: 3, number: 'singular' }),
      makeSurface('leemos', { formType: 'finite', mood: 'indicative', tense: 'present', person: 1, number: 'plural' }),
      makeSurface('leen', { formType: 'finite', mood: 'indicative', tense: 'present', person: 3, number: 'plural' }),
      makeSurface('leyó', { formType: 'finite', mood: 'indicative', tense: 'preterite', person: 3, number: 'singular' }),
      makeSurface('leyeron', { formType: 'finite', mood: 'indicative', tense: 'preterite', person: 3, number: 'plural' }),
    ],
  },
  {
    lemma: 'estudiar',
    ...
    frequencyScore: 0.74,
    forms: [
      makeSurface('estudiar', { formType: 'infinitive', mood: 'infinitive' }),
      makeSurface('estudio', { formType: 'finite', mood: 'indicative', tense: 'present', person: 1, number: 'singular' }),
      makeSurface('estudias', { formType: 'finite', mood: 'indicative', tense: 'present', person: 2, number: 'singular' }),
      makeSurface('estudia', { formType: 'finite', mood: 'indicative', tense: 'present', person: 3, number: 'singular' }),
      makeSurface('estudiamos', { formType: 'finite', mood: 'indicative', tense: 'present', person: 1, number: 'plural' }),
      makeSurface('estudian', { formType: 'finite', mood: 'indicative', tense: 'present', person: 3, number: 'plural' }),
      makeSurface('estudió', { formType: 'finite', mood: 'indicative', tense: 'preterite', person: 3, number: 'singular' }),
      makeSurface('estudiaron', { formType: 'finite', mood: 'indicative', tense: 'preterite', person: 3, number: 'plural' }),
    ],
  },
  {
    lemma: 'deporte',
    ...
    frequencyScore: 0.7,
    forms: [
      makeSurface('deporte', { number: 'singular', gender: 'masc' }),
      makeSurface('deportes', { formType: 'plural', number: 'plural', gender: 'masc' }),
    ],
  },
  {
    lemma: 'música',
    ...
    frequencyScore: 0.78,
    forms: [
      makeSurface('música', { number: 'singular', gender: 'fem' }),
      makeSurface('musica', { formType: 'variant', number: 'singular', gender: 'fem', confidence: 0.7 }),
    ],
  },
  {
    lemma: 'doler',
    ...
    frequencyScore: 0.8,
    forms: [
      makeSurface('doler', { formType: 'infinitive', mood: 'infinitive' }),
      makeSurface('duele', { formType: 'finite', mood: 'indicative', tense: 'present', person: 3, number: 'singular' }),
      makeSurface('duelen', { formType: 'finite', mood: 'indicative', tense: 'present', person: 3, number: 'plural' }),
      makeSurface('dolió', { formType: 'finite', mood: 'indicative', tense: 'preterite', person: 3, number: 'singular' }),
      makeSurface('dolieron', { formType: 'finite', mood: 'indicative', tense: 'preterite', person: 3, number: 'plural' }),
    ],
  },
