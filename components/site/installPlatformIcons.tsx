...
export function InstallIconAndroid({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M17.6 9.48l1.84-3.24c.16-.31.04-.69-.26-.85-.29-.18-.68-.12-.86.12l-1.88 3.28a11.43 11.43 0 00-8.94 0L5.5 5.11c-.18-.24-.57-.3-.86-.12-.3.16-.42.54-.26.85l1.84 3.24A10.07 10.07 0 001.5 18h21a10.07 10.07 0 00-4.9-8.52zM7 15.25c-.69 0-1.25-.56-1.25-1.25s.56-1.25 1.25-1.25 1.25.56 1.25 1.25-.56 1.25-1.25 1.25zm10 0c-.69 0-1.25-.56-1.25-1.25s.56-1.25 1.25-1.25 1.25.56 1.25 1.25-.56 1.25-1.25 1.25z" />
    </svg>
  )
}

/** Logo Apple (SVG Repo — apple-logo-svgrepo-com.svg), `currentColor` para tema claro/oscuro. */
