...
/** Metadatos originales de `/instalar` (restaurar en `app/instalar/page.tsx` al reactivar). */
...
/** Contenido completo de `/instalar` (desactivado en la ruta; importar desde `app/instalar/page.tsx` para reactivar). */
