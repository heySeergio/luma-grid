...
/**
 * Respaldo congelado del contenido de `/instalar` (referencia en código; no hay ruta pública).
 * La página en vivo es `InstalarPageContent.tsx`.
 */
export const INSTALAR_ARCHIVO_PAGE_METADATA = {
...
export default function InstalarPageContentArchivo() {
  return (
