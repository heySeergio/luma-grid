                      ...
                      <div className="ui-floating-panel mt-3 rounded-2xl px-4 py-3">
                        {detectingLexeme ? (
                          ...
                          <div className="space-y-1.5">
                            ...
                            {lexemePreview.confidence < 0.5 && !editingSymbol.manualGrammarOverride ? (
                              <p className="rounded-lg bg-amber-50 px-2.5 py-2 text-[11px] leading-snug text-amber-950 dark:bg-amber-900/30 dark:text-amber-100">
                                Confianza baja en la detección automática. Revisa el tipo de palabra o activa el control gramatical manual antes de
                                guardar para mejorar conjugación y predicción.
                              </p>
                            ) : null}
